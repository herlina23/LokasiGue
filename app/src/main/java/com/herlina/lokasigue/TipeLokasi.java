...
public class TipeLokasi extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
            ...
            placeResult.addOnCompleteListener(new OnCompleteListener<PlaceLikelihoodBufferResponse>() {
                ...
                public void onComplete(@NonNull Task<PlaceLikelihoodBufferResponse> task) {
                    if(task.isSuccessful()){
                        ...
                        mLocationTextView.setText(getString(R.string.alamat_detail,"location not found",result,System.currentTimeMillis()));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLocationCalback = new LocationCallback(){
            ...
            public void onLocationResult(LocationResult locationResult) {
                if (mTrackingLocation){
                    new DapatkanAlamatTask(TipeLokasi.this,TipeLokasi.this).execute(locationResult.getLastLocation());
                }
            }
        };
    }
    ...
    private void mulaiTrackingLokasi(){
        if(ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)!= PackageManager.PERMISSION_GRANTED){
            ...
            mLocationTextView.setText(getString(R.string.alamat_detail,"searching for places","searching for address",System.currentTimeMillis()));
    ...
    private void stopTrackingLokasi(){
        if(mTrackingLocation){
            ...
            mLocationButton.setText("Tracking Now");
            mLocationTextView.setText("Tracking stopped");
            mRotateAnim.end();
        }
